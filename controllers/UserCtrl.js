...
const sendMailController=async(req,res)=>{
   ...
   try {
     ...
     res.status(200).json({success:false ,message:`Erroe in mailController ${process.env.EMAIL} ${process.env.PASSWORD} ${process.env.JWT_SECRET} ${process.env.TWILIO_WHATSAPP_NUMBER}`,error});
   }
}
